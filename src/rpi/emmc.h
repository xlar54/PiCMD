...
// Called repeatedly while the SD driver is spinning on the card. An access
// can take tens of milliseconds, and on a real CMD HD the serial bus does
// not care what the CPU is doing - the 6522 acknowledges ATN in hardware.
// This is how the emulated equivalent keeps that promise.
extern void (*EMMCBlockingWaitHook)(void);
