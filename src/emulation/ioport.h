...
// One 8 bit bidirectional port of a 6522 VIA: separate input and output
// latches, a direction mask, and a callback fired whenever what the port is
// actually driving changes. The CMD HD has four of them (two VIAs), and both
// the IEC bus and the machine reach in and work with them directly.
